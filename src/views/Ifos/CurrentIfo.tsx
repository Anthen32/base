    ...
    <div>
      ...
      <LaunchIfoCallout>
        <div>
          ...
          <List>
            <li>{TranslateString(596, 'Buy KYRIOS and BNB tokens')}</li>
            <li>{TranslateString(598, 'Get KYRIOS-BNB LP tokens by adding KYRIOS and BNB liquidity')}</li>
          </List>
          <Flex mb="16px">
            <LinkExternal href="https://exchange.pancakeswap.finance/#/swap" mr="16px">
              {TranslateString(1060, 'Buy KYRIOS')}
            </LinkExternal>
          ...
          <List>
            <li>{TranslateString(602, 'While the sale is live, commit your KYRIOS-LP tokens to buy the IFO tokens')}</li>
          </List>
