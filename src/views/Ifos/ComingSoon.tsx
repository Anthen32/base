        ...
        <div>
          <Block>
            ...
            <Text mb={3}>
              {TranslateString(
                504,
                'You’ll pay for the new tokens using KYRIOS-BNB LP tokens, which means you need to stake equal amounts of KYRIOS and BNB in a liquidity pool to take part.',
              )}
            </Text>
            <Text mb={3}>
              <LiquidityLink href="https://exchange.pancakeswap.finance/#/add/ETH/0x0E09FaBB73Bd3Ade0a17ECC321fD13a19e81cE82">
                {TranslateString(506, 'Get KYRIOS-BNB LP >')}
              </LiquidityLink>
            </Text>
            <Text mb={3}>
              {TranslateString(508, 'The project gets the BNB, PancakeSwap burns the KYRIOS.')}
              <br />
