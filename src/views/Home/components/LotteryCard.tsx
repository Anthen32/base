...
const FarmedStakingCard = () => {
    ...
    if (!allowance.toNumber()) {
      return (
        <Button width="100%" disabled={requestedApproval} onClick={handleApprove}>
          {TranslateString(494, 'Approve TAQUITO')}
        </Button>
      )
    }
    return (
  ...
  const [onPresentBuy] = useModal(<BuyModal max={cakeBalance} tokenName="TAQUITO" />)
  ...
  return (
    <StyledLotteryCard>
      <CardBody>
        ...
        <CardImage src="/images/ticket.svg" alt="taquito logo" width={64} height={64} />
        <Block>
          <Label>{TranslateString(552, 'TAQUITO to Collect')}:</Label>
          <CakeWinnings />
        </Block>
        <Block>
