...
import { Button, useModal, AutoRenewIcon, Link, Text, Flex } from '@pancakeswap-libs/uikit'
...
const UnStaked: React.FunctionComponent<FarmWithStakedValue> = ({
  pid,
  isTokenOnly,
  lpSymbol,
  lpAddresses,
  ...
  return (
    ...
    <ActionTitles>
      <Flex justifyContent="space-between">
        ...
        <Text ml="5px" mt="-3px" color="#f09553" fontSize="12px">
          {displayBalance} / {lpSymbol}
        </Text>
      </Flex>
      <Flex justifyContent="flex-end">
          <Link fontWeight="400" fontSize="12px" href={externalLink}>
           <Text fontSize="11px" color='#7f7f7f'> Get {lpSymbol}</Text>
          </Link>{' '}
        </Flex>
    </ActionTitles>
    <WithdrawModal
